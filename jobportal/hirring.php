  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo web_root; ?>plugins/jobportal/images/cg_4.jpg');" data-stellar-background-ratio="0.5">
          ...
          <div class="col-md-12 ftco-animate">
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                <div class="job-post-item-header d-flex align-items-center">
                  ...
                  <div class="badge-wrap">
                   <span class="bg-success text-white badge py-2 px-3"><?php echo $result->CATEGORY ?></span>
                  </div>
                </div>
              ...
              <div class="ml-auto d-flex">
                <a href="<?php echo web_root; ?>index.php?q=apply&job=<?php echo $result->JOBID;?>&view=personalinfo" class="btn btn-success py-2 mr-1">Apply Job</a>
